...
unsigned int nStakeMinAge = 60 * 60 * 6  * 1;	//2h, minimum age for coin age:  6h
unsigned int nStakeMaxAge = 60 * 60 * 24 * 60;	//30d, stake age of full weight:  10d 60*60*24*10
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1418398998;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64_t nSubsidy = 0 * COIN;
     ...
     if(nHeight < 1000 ) nSubsidy = 100000000 * COIN;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
    ...
    int nPoWHeight = GetPowHeight(pindex) + 1;
     ...
     if(nPoWHeight < 1000 )	 nSubsidy = 100000000 * COIN;
     else         	      	 nSubsidy = 0 * COIN;
...
//static const int YEARLY_POS_BLOCK_COUNT = 1 * 60 * 24 * 365;
...
//    if(nHeight < 4 * YEARLY_POS_BLOCK_COUNT)
//	nSubsidy *= 4;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in UNCoin
    bool fStrictPayToScriptHash = true; // Always active in UNCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "UNCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2014.12.13 Silence of HongKong";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xe8d8e49682b0a56a90cc5991e28c9b30493486da3c8a8b5ead3ba00ded93e1c9"));
